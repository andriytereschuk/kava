		...
		<div class="row">
			...
			<div class="col-lg-4">
				...
				<div class="prod-info" data-height="44">
					<div class="prod-wrap">
						<div class="prod-item">
							<div class="prod-label pull-left">Регіон</div>
							<div class="right-info">Ель Тріунфо, Колінас, Санта Барбара</div>
						</div>

						<div class="prod-item">
							<div class="prod-label pull-left">Висота</div>
							<div class="right-info">1400-1800 м</div>
						</div>

						<div class="prod-item">
							<div class="prod-label pull-left">Плантація</div>
							<div class="right-info">Кооператив Капукас</div>
						</div>

						<div class="prod-item">
							<div class="prod-label pull-left">Різновид</div>
							<div class="right-info">Катуай</div>
						</div>

						<div class="prod-item">
							<div class="prod-label pull-left">Процес</div>
							<div class="right-info">Митий</div>
						</div>

						<div class="prod-item">
							<div class="prod-label pull-left">Сертифікація</div>
							<div class="right-info">Organic</div>
						</div>

						<div class="prod-item">
							<div class="prod-label pull-left">Класифікація</div>
