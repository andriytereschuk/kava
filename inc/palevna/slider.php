	...
	<div class="container container-full">
		...
		<div class="slider-top swiper-container">
		    ...
		    <div class="swiper-wrapper">
		        <!-- Slides -->
		        <div class="swiper-slide" style="background-image: url('images/palyarna.jpg');"></div>
		        <div class="swiper-slide" style="background-image: url('images/palyarna.jpg');"></div>
		        <div class="swiper-slide" style="background-image: url('images/palyarna.jpg');"></div>
		    </div>
...
Окрім того, кава від «Світу кави» - тільки свіжого обсмаження.</p>
			...
			<iframe src="https://player.vimeo.com/video/78811182" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
